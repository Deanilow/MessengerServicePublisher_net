...
namespace MessengerServicePublisher.Core.Helper
{
    public static class GmailHelper
    {
        ...
        /// <param name="ClientId">'ClientId' value created in Gmail API Console.</param>
        ...
        public static string GetBodyTextMessage(Message message)
        {
            string requiredMessage = string.Empty;
            MessagePart requiredMessagePart = null;
            if (message.Payload.MimeType == "text/plain")
                requiredMessagePart = message.Payload;
            ...
            else
            {
                ...
                {
                    requiredMessagePart = message.Payload.Parts.FirstOrDefault(x => x.MimeType == "text/plain");
                    if (requiredMessagePart.Body.Data == "" || requiredMessagePart.Body.Data == null)
                        requiredMessagePart = message.Payload.Parts.FirstOrDefault(x => x.MimeType == "text/html");
                }
            }
            if (requiredMessagePart != null)
            {
